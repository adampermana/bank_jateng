  ...
  List<Widget> _buildDialogActions() {
    switch (_currentStep) {
      ...
      case CardOperationStep.failed:
        return [
          ElevatedButton(
              onPressed: _cancelOperation, child: const Text('Close')),
        ];
      case CardOperationStep.cardInfo:
        return [
          ElevatedButton(
              ...
              child: const Text('No')),
          ElevatedButton(
              onPressed: _onCardInfoConfirmed, child: const Text('Yes')),
        ];
      case CardOperationStep.success:
        return [
          ElevatedButton(
  ...
  Widget _buildInsertCardScreen() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text('Please insert your card to confirm PIN',
  ...
  Widget _buildCardInfoScreen() {
    return Column(
      children: [
        ...
        const SizedBox(height: 24),
        const Text('Do you want to continue with this card?',
    ...
    return Column(
      children: [
        const Text('Enter PIN',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        const Text('Enter your 6-digit PIN to confirm',
            textAlign: TextAlign.center,
        ...
        const SizedBox(height: 16),
        Text('Time remaining: $_remainingPinTime seconds',
            style: TextStyle(
  ...
  Widget _buildSuccessScreen() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        const Text('PIN confirmed successfully!',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 12),
        Text('Dialog will close in $_remainingSuccessTime seconds',
