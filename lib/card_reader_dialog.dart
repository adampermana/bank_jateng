      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildCardInfoRow('Card Number', cardData.getFormattedCardNumber() ?? 'Not available'),
                const SizedBox(height: 8),
                _buildCardInfoRow('Expiry Date', cardData.getFormattedExpiryDate() ?? 'Not available'),
                const SizedBox(height: 8),
                _buildCardInfoRow('Card Type', cardData.cardType ?? 'Not available'),
              ],
            ),
          ),
          const SizedBox(height: 24),
