...
class NetworkService {
  static const String serverHost = '192.168.88.177';
  ...
  static LogonResponse _parseLogonResponse(String response) {
    try {
        ...
        if (_isBitSet(bitmap, i - 1)) {
          if (i == 39) {
            ...
            return LogonResponse(
              ...
              errorMessage: responseCode != '00' ? 'Logon failed with code: $responseCode' : null,
            );
          }
          offset += _getFieldLength(i);
        }
      }
      ...
      return LogonResponse(
        success: false,
        responseCode: '30',
        errorMessage: 'Response code not found',
      );
    } catch (e) {
      return LogonResponse(
        success: false,
  ...
  static int _getFieldLength(int fieldNum) {
    switch (fieldNum) {
